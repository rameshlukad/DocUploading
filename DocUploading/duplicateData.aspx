<%@ Page Title="" Language="C#" MasterPageFile="~/CustomMasterPage.Master" AutoEventWireup="true" CodeBehind="duplicateData.aspx.cs" Inherits="DocUploading.duplicateData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <div class="container py-3">
        <h2 class="text-center ">Duplicate Data</h2> 
            <div class="card-body"> 
